...
subtitle: "Модель боевых действий - вариант 4"
...
В начальный момент времени страна $X$ имеет армию численностью 35000 человек, а в распоряжении страны $Y$ армия численностью в 49000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.55x(t) - 0.9y(t) + 2*|sin(t)|
	\\   
	\frac{dy}{dt}= -0.8x(t) - 0.63y(t) + cos(13t)+1
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.35x(t) - 0.46y(t) + 2*|sin(2t)|
	\\   
	\frac{dy}{dt}= -0.2x(t)y(t) - 0.6y(t) + cos(0.5t)+1
 \end{cases}
$$
...
y0 = 49000;//численность второй армии
t0 = 0;//начальный момент времени
a = 0.35;//константа, характеризующая степень влияния различных факторов на потери армии х
b = 0.46;//эффективность боевых действий армии у
c = 0.2;//эффективность боевых действий армии х
h = 0.6;//константа, характеризующая степень влияния различных факторов на потери армии у
tmax = 1;//предельный момент времени
dt = 0.05;//шаг изменения времени
t = [t0:dt:tmax];
function p=P(t)//возможность подхода подкрепления к армии х
